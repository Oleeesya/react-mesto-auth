  ...
  return (
    ...
    <PopupWithForm name="create" title="Новое место" isOpen={isOpen} onClose={onClose}
      ...
      <label className="popup__label">
        <input className="popup__input popup__input_edit_header" id="title-input-addplace" type="text" name="name"
          required maxLength="40" minLength="2" placeholder="Название" value={name || ''} onChange={handleChangeName} />
        <span className="popup__input-error title-input-error"></span>
      </label>
      <label className="popup__label">
        <input className="popup__input popup__input_edit_paragraph" id="subtitle-input-addplace" type="text" name="about"
